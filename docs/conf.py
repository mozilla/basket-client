...
project = u'github.com/mozilla/basket-client'
...
latex_documents = [
  ('index', 'basket-client.tex', u'Basket Client Documentation',
   u'Mozilla', 'manual'),
]
...
man_pages = [
    ('index', 'github.com/mozilla/basket-client', u'Basket Client Documentation',
     [u'Mozilla'], 1)
]
